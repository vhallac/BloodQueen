...
elseif (GetLocale() == "ruRU") then --thanks Kadrkadr and mobvideo 
	...
	BloodQueen_Local={
		...
		["firstbite"] = "First bite detected, enabled mode for %dman. Good Luck!";
		...
		--xml
		["Timer Slider"] = "Assign target %d seconds\nbefore damage buff expires";
		["BloodQueen"] = "BloodQueen";
		...
		["Profile"] = "Profile";
		--modes
		["Mode Dual Prio Damage Meter Trade"] = "In this mode all targets are chosen according damage meter, respecting each individual list (melee bite melee, ranged bite ranged, but first bite is opposite)";
		["Mode Dual Prio Damage Meter"] = "In this mode all targets are chosen according damage meter, respecting each individual list (melee bite melee, ranged bite ranged)";
		["Mode Dual Prio Trade"] = "In this mode all targets are chosen according priority lists (melee bite melee, ranged bite ranged, but first bite is opposite)";
		["Mode Dual Prio"] = "In this mode all targets are chosen according priority lists (melee bite melee, ranged bite ranged)";
		["Mode Normal Prio"] = "In this mode all targets are chosen according priority list";
		["Mode Damage Meter"] = "In this mode all targets are chosen according damage meter";
